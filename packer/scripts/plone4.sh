...
# Download Installer
su -c "wget --no-check-certificate https://launchpad.net/plone/4.3/4.3.5/+download/Plone-4.3.5-UnifiedInstaller.tgz" vagrant

# Unpack Installer
su -c "tar -xf Plone-4.3.5-UnifiedInstaller.tgz" vagrant

# Run Installer
su -c "./Plone-4.3.5-UnifiedInstaller/install.sh --password=plone standalone" vagrant
